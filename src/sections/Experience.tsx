...
const Experience: FC = () => {
  ...
  const experienceData = [
    ...
    },
    {
      ...
      description: [
        'Contributed to front-end development using HTML, CSS, JavaScript, and modern frameworks',
            ...
            return (
              ...
              >
                ...
                <div className="absolute left-6 md:left-1/2 top-0 transform -translate-x-1/2 flex justify-center items-center">
                  <motion.div
                    className={`w-8 h-8 md:w-10 md:h-10 rounded-full bg-gray-800 border-2 ${index === 0 ? 'border-emerald-500' : 'border-blue-500'} flex items-center justify-center z-10 shadow-lg ${colors.glow}`}
                    initial={{ scale: 0 }}
                  ...
                  >
                    <Briefcase className={index === 0 ? 'text-emerald-400' : 'text-blue-400'} size={16} />
                  </motion.div>
                </div>
                ...
                <div className={`ml-12 md:ml-0 md:w-1/2 ${index % 2 === 0 ? 'md:pr-8 lg:pr-12' : 'md:pl-8 lg:pl-12'}`}>
                  <motion.div 
                    ...
                    whileHover={{ 
                      y: -5, 
                      boxShadow: `0 20px 40px -10px rgba(${index === 0 ? '16,185,129' : '59,130,246'}, 0.3)`,
                  ...
                  >
                    ...
                    <motion.div 
                      ...
                      } ${index === 0 ? 'bg-gradient-to-r from-transparent to-emerald-500/80' : 'bg-gradient-to-r from-transparent to-blue-500/80'}`}
                      style={{ 
                        ...
                        >
                          {item.description.map((desc, i) => (
                            <div key={i} className="flex items-start gap-2">
                              <ArrowRight size={16} className={`mt-1 ${colors.text}`} />
